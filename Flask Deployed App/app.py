...
# Load the CSV data
disease_info = pd.read_csv(r"C:\Medicinal_plant\Plant-Disease-Detection\Flask Deployed App\disease_info.csv", encoding='cp1252')
supplement_info = pd.read_csv(r"C:\Medicinal_plant\Plant-Disease-Detection\Flask Deployed App\supplement_info.csv", encoding='cp1252')

# Initialize the model
model = CNN.CNN(39)  # Make sure the CNN model has 39 classes
model.load_state_dict(torch.load(r"C:\Medicinal_plant\Plant-Disease-Detection\plant_disease_model_1_latest.pt"))
model.eval()
