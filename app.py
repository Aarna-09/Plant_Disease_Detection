...
# Load the CSV data
disease_info = pd.read_csv(r"C:\Users\saanj\Desktop\Plant-Disease-Detection\disease_info.csv", encoding='cp1252')
supplement_info = pd.read_csv(r"C:\Users\saanj\Desktop\Plant-Disease-Detection\supplement_info.csv", encoding='cp1252')

# Initialize the model
model = CNN.CNN(39)  # Make sure the CNN model has 39 classes
model.load_state_dict(torch.load(r"C:\Users\saanj\Desktop\Plant-Disease-Detection\plant_disease_model_1_latest.pt"))
model.eval()
